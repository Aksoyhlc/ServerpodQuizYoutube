...
class QuizRepository {
  ...
  final detach = const QuizDetachRepository._();

  final detachRow = const QuizDetachRowRepository._();
...
class QuizDetachRepository {
  const QuizDetachRepository._();
  ...
  Future<void> questions(
    ...
    var $quizQuestion =
        quizQuestion.map((e) => e.copyWith(quizId: null)).toList();
    await session.db.update<_i2.QuizQuestion>(
      $quizQuestion,
      columns: [_i2.QuizQuestion.t.quizId],
    );
...
class QuizDetachRowRepository {
  const QuizDetachRowRepository._();
  ...
  Future<void> questions(
    ...
    var $quizQuestion = quizQuestion.copyWith(quizId: null);
    await session.db.updateRow<_i2.QuizQuestion>(
      $quizQuestion,
      columns: [_i2.QuizQuestion.t.quizId],
    );
